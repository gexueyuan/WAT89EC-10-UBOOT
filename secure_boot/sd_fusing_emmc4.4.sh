...
echo "---------------"
echo "u-boot signing"
./size_adjust ../u-boot.bin u-boot-306944.bin 306944 
./codesigner_v20 -v2.0 u-boot-306944.bin u-boot-300K.bin.signed -STAGE2  #mkh: this adds 256 bytes signed data.
rm u-boot-306944.bin

####################################
#< signedBL1 image copy & u-boot image concatenation>
rm ./sdfuse/*
cp 6450_EVT1.sbl1.bin ./sdfuse/BL1.bin.signed
cat BL2-32K.bin.signed u-boot-300K.bin.signed > ./sdfuse/u-boot.bin.sd.signed
rm BL2-32K.bin.signed
rm u-boot-300K.bin.signed
