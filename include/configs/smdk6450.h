 ...
 * (easy to change)
 */
#define CONFIG_S5P6450		1		/* in a SAMSUNG S5P6450 SoC */
#define CONFIG_S5P64XX		1		/* in a SAMSUNG S5P64XX Family  */
#define CONFIG_SMDK6450		1		/* on a SAMSUNG SMDK6450 Board  */
#define CONFIG_EVT1		1		/* EVT1 */
#define CONFIG_EMMC_4_4		1 	/* Enable this and set boot device to 2, for emmc 4.4 booting*/
//#define CONFIG_SECURE_BOOT	1
//#define MEM_TYPE_MDDR 		1
#define MEM_TYPE_DDR2 	1

#if defined(CONFIG_SECURE_BOOT)
#define CONFIG_SECURE_KERNEL_BASE       0xC0008000
#define CONFIG_SECURE_KERNEL_SIZE       0x00300000
#define CONFIG_SECURE_ROOTFS_BASE       0xC0800000
#define CONFIG_SECURE_ROOTFS_SIZE       0x00180000
#endif
 ...
 */
#define CONFIG_SERIAL1          	/* we use SERIAL 2 on SMDK6450 */
...
//#define CONFIG_BOOTCOMMAND      "fdisk -c 2;fatformat mmc 2:1;ext2format mmc 2:2;ext3format mmc 2:3;ext3format mmc 2:4;sdfuse flashall"//envi ++
#define CONFIG_BOOTCOMMAND	"movi read kernel 20008000;movi read rootfs 20800000 C00000;bootm 20008000 20800000" //ramdisk size //envi --
...
#define set_pll(mdiv, pdiv, sdiv)	(1<<31 | mdiv<<16 | pdiv<<8 | sdiv)//envi ++
//#define set_pll(mdiv, pdiv, sdiv)	(mdiv<<16 | pdiv<<8 | sdiv) //envi --
...
#define CFG_SDFUSE_MMCDEV_DEST      EMMC_DEV //to where sdfuse flashes.
