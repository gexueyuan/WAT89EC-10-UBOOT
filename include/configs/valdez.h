...
#define CONFIG_VALDEZ		1		
#define CONFIG_EVT1		1		/* EVT1 */
#define SMDK6450_EVT1		0
 ...
 */
#define CONFIG_SERIAL3          	/* we use SERIAL 2 on SMDK6450 */
...
#define CFG_PROMPT		"Valdez # "	/* Monitor Command Prompt	*/
