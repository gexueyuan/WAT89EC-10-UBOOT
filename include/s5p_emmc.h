...
/*****************************************************/
#define MSHCI_BLOCK_SIZE 512
#define MSHCI_MAKE_BLKSZ(dma, blksz) (((dma & 0x7) << 12) | (blksz & 0xFFF))
...
#define MSHCI_RESET_ALL  CTRL_RESET | FIFO_RESET | DMA_RESET//(0x1)
...
#define TX_WMARK		(0x10) // use half fifo as watermark for rx and tx
#define RX_WMARK		(0x10)//
#define MRX_WMARK		(RX_WMARK << 16)
#define MTX_WMARK		(TX_WMARK << 0)
