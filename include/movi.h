...
/* partition information */
#define PART_SIZE_BL_EMMC_4_4	(300 * 1024)
#define PART_SIZE_BL		(512 * 1024)
#define PART_SIZE_KERNEL	(4 * 1024 * 1024)
...
#define MOVI_BL2_BLKCNT_EMMC_4_4 (PART_SIZE_BL_EMMC_4_4 / MOVI_BLKSIZE)	/* 512KB */
