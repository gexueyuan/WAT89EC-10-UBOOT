...
//#define FASTBOOT_MAX_ENDPOINTS 16 //envi ++
...
void fboot_usb_init_phy(void)
{
	...
	writel(0xa0, S5P_OTG_PHYPWR);
	//writel(0x21, S5P_OTG_PHYCLK);//envi  --
        writel(0x62, S5P_OTG_PHYCLK);//envi ++ On chip clock connected to CLKCORE  12MHz
#else
#error "* CFG_ERROR : you have to select C100 or C110 for Android Fastboot"
#endif
...
#elif defined(CONFIG_VALDEZ)  
        device_strings[DEVICE_STRING_PRODUCT_INDEX]       = "valdez-6450";
#else
